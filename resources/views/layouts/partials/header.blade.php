          ...
          <div class="header__menu">
            <ul class="header__nav">
              <li class="header__nav-item">
                <a href="{{ route('home.index') }}" class="header__nav-link">Home</a>
              </li>
              <li class="header__nav-item">
                <a href="{{ route('car.index') }}" class="header__nav-link">Cars</a>
              </li>
              <li class="header__nav-item">
                <a href="{{ route('about.show') }}" class="header__nav-link">About Us</a>
              </li>
              <li class="header__nav-item">
                <a href="{{ route('contacts.show') }}" class="header__nav-link">Contact Us</a>
              </li>
            </ul>
          </div>
